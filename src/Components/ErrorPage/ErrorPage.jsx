...
const ErrorPage = () => {
    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-center h-[100vh] md:gap-6 gap-3 bg-[url('/assets/error_bg.jpg')]">
                <h3 className="md:text-5xl text-3xl text-center text-white">Page not found!</h3>
                <img className="md:w-[300px] md:h-[300px] w-[200px] h-[200px] rounded-full" src="/assets/error.png" alt="error img" />
